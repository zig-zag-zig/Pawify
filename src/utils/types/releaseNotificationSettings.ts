...
export const MAX_RELEASE_NOTIFICATION_LOOKBACK_MONTHS =
  RELEASE_NOTIFICATION_LOOKBACK_MONTH_OPTIONS[RELEASE_NOTIFICATION_LOOKBACK_MONTH_OPTIONS.length - 1];

const releaseNotificationLookbackMonthSet = new Set<number>(RELEASE_NOTIFICATION_LOOKBACK_MONTH_OPTIONS);
