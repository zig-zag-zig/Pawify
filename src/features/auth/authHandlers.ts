...
export const changeEmailHandler = authenticatedHandler('/changeEmail', async ({ req, res, userId }) => {
    const email = requireString(req.body, 'email');
...
export const deleteUserAccountHandler = authenticatedHandler('/deleteUserAccount', async ({ res, userId }) => {
