...
export type ReleaseNotificationSettingsRepository = {
  ...
  saveSettings(userId: string, settings: ReleaseNotificationSettings): Promise<ReleaseNotificationSettings>;
};
...
export type NewReleaseRepository = {
  removeReleasesOutsideSettings(userId: string, settings: ReleaseNotificationSettings): Promise<void>;
};
...
export type UserSettingsNotifier = {
  notifySettingsChanged(userId: string, settings: ReleaseNotificationSettings, sourcePushToken?: string): Promise<void>;
